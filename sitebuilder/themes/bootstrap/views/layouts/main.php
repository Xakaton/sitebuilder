...
<head>
    ...
    <![endif]-->
    <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/tinymce/tinymce.js"></script>
...
<div class="container" id="page">
    ...
    <div id="footer">
        Copyright &copy; <?php echo date('Y'); ?> by <a href="mailto:proggergood@gmail.com">ProggerGood</a>.<br/>
